  ...
  useEffect(() => {
    ...
    const fetchFriends = async () => {
      try {
        ...
        const response = await axios.get(`${getFriends}/${currentUser._id}`, { signal });
        setFriends(response.data);
        hasFetchedFriends = true; // Mark as fetched
      } catch (error) {
    ...
    return () => {
      controller.abort(); // Cancel the API request if the component unmounts
    };
  }, []); // No dependencies
